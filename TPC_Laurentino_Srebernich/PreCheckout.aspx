  ...
  <div class='window'>
   ...
   <%foreach (Dominio.Carrito item in carritofinal)
        ...
        <table class='order-table'>
          <tbody>
            <tr>
              <td><img src="<% = item.Producto.Imagen_principal %>" class='full-width'></img>
              </td>
              <td>
                <br> <span class='thin'><%=item.Producto.Nombre %></span>
                <br> <%=item.Producto.Descripcion %><br> <span class='thin small'> Color: <%=item.Producto.Color %>, Talle: <%=item.Producto.Talle %><br><br></span>
              </td>
    ...
    <%  } %>
       ...
       <h2 class="TITULO-PRECHECKOUT">Nro de Documento *</h2>   
             <asp:TextBox ID="TextBox1" Type="text" Class="form-control" placeholder="Documento" required="true" runat="server" ></asp:TextBox>
    ...
    <div class="form-check">
        <input id="enviomercadoenvios" name="paymethod" type="radio" class="form-check-input" style="font-size: medium" required />
        <label for="transferencia">Mercado Envio</label>
    </div>

    <div class="form-check">
        <input id="Retirolocal" name="paymethod" type="radio" class="form-check-input" style="font-size: medium" required />
        <label for="Mercadopago">Retiro en el local</label>
    </div>

    <div class="form-check">
        <input id="Motomensajeria" name="paymethod" type="radio" class="form-check-input" style="font-size: medium" required />
